...
@Slf4j
@EnableAsync
//启用 Spring 异步方法执行功能。这使得你可以使用 @Async 注解来异步执行方法
@Configuration
//允许从配置文件中注入 ThreadPoolConfigProperties 类中的属性。这些属性用于配置线程池
...
public class ThreadPoolConfig {
    ...
    public ThreadPoolExecutor threadPoolExecutor01(ThreadPoolConfigProperties properties) {
        // 实例化策略
        //选择不同的拒绝策略来处理线程池的任务拒绝情况。
        // 根据 ThreadPoolConfigProperties 中的配置选择不同的策略。
